$(function () {
    ...
    function editableTable() {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[7].innerHTML = '<input type="text" class="input-mini" id="timepicker" value="' + aData[7] + '">';
			 jqTds[8].innerHTML = '<input type="text" class="input-mini" id="timepicker" value="' + aData[8] + '">';
