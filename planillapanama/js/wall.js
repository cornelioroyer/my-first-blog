...
//Web Camera image
$('#webcam_button').on("click",function() 
{
$(".camclick").show();
$('#imageupload').slideUp('fast');
...
$("#previeww").html('<img src="img/loader.gif"/>');
...
data: "lastid="+ ID, 
cache: false,
beforeSend: function(){ $("#more"+ID).html('<img src="img/ajaxloader.gif" />'); },
success: function(html){
$("div#content2").append(html);
$("#more"+ID).remove();
}
});
}
