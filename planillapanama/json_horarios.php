...
$query  = "select a.id,a.codigo_empleado,a.turno,b.nombre,b.apellido,c.hora_inicio,c.hora_salida,a.numero_planilla,a.fecha,a.status,a.autorizado,a.entrada1,";
...
$query .= "where a.compania = e.compania  and a.compania = b.compania  and a.compania = c.compania  and a.codigo_empleado = b.codigo_empleado ";
...
while ($fila=pg_fetch_array($resultado)) {
	...
	$rows[] = array($fila['id'],$nombre_proyecto,$nombre_completo,$fila['codigo_empleado'],$fila['turno'],$fila['fecha'],$fila['status'],$fila['autorizado'],$entrada1,$descanso_inicio,$descanso_fin,$salida1,$fila['implemento'],$entrada2,$salida2,$entrada3,$salida3,$opciones);

 }}
$json_array = json_encode(array("aaData" =>  $rows  ));
echo $json_array;
